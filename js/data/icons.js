...
const SVG_ICONS = {
    ...
    course: '<img src="images/whitecourse.png" alt="Course" class="icon-img-green" width="28" height="28">',
    nest: '<img src="images/whitenest.png" alt="Nest" class="icon-img-green" width="28" height="28">',
    yummy: '<img src="images/whiteyummy.png" alt="Yummy" class="icon-img-green" width="28" height="28">',
    spot: '<img src="images/whitemap.png" alt="Spot" class="icon-img-green" width="28" height="28">',
    ...
    galleryCalendar: '<img src="images/whitecourse.png" alt="Course" class="icon-img-green" width="32" height="32">',
    ...
    galleryMapPin: '<img src="images/whitemap.png" alt="Spot" class="icon-img-green" width="32" height="32">',
